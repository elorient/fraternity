...
describe('Service Tests', () => {
    describe('Association Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Association(0, 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Association', async () => {
            ...
            it('should return a list of Association', async () => {
                const returnedFromService = Object.assign(
                    {
                        nSiret: 'BBBBBB',
                        statut: 'BBBBBB'
            ...
            it('should delete a Association', async () => {
