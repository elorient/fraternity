...
import { IHelpAction, HelpAction } from 'app/shared/model/help-action.model';

describe('Service Tests', () => {
    describe('HelpAction Service', () => {
        let injector: TestBed;
        let service: HelpActionService;
        let httpMock: HttpTestingController;
        let elemDefault: IHelpAction;
        beforeEach(() => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a HelpAction', async () => {
            ...
            it('should delete a HelpAction', async () => {
