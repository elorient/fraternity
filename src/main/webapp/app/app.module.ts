...
import { FraternityCoreModule } from 'app/core';
import { FraternityAppRoutingModule } from './app-routing.module';
...
@NgModule({
    imports: [
        ...
        FraternitySharedModule.forRoot(),
...
export class FraternityAppModule {
